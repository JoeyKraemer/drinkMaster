...
def action (drink):
    ...
    #drinks
    drink1 = [
        "$x","G90","G0 F9000", "G0 Z1900", "G0 F15000", "G0 Y0215", "G0 X0115",
        "G0 F6000","G92 z0", "G0 Z-0900", "G04 P5","G92 z0", "G0 Z0900", 
        "G0 F15000","G92 x0", "G0 X-220","G92 z0", "G0 Z-800", "G04 P5","G92 z0", "G0 Z0800"
        ] # Drink 1
    drink2 = [
        "$x","G90","G0 F9000","G0 Z1900","G0 F15000","G0 Y0083","G0 X0115",
